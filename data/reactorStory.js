...
export const reactorStory = {
  ...
  lab: {
    ...
    ring01: { z: 0.4, rotation: 0.12 },
    ring02: { z: -0.36, rotation: -0.1 },
    ring03: { z: 0.52, rotation: 0.12 },
  ...
  contact: {
    ...
    ring01: { z: 0.88, rotation: 0.18 },
    ring02: { z: -0.82, rotation: -0.16 },
    ring03: { z: 1.12, rotation: 0.2 },
    coolingSystem: { z: 0.48, radial: 0.78 },
    magneticContainment: { z: -0.52, opacity: 1 },
    energyConduits: { intensity: 1, sequential: 1 },
    coreHousing: { z: -0.92 },
    core: { rotationSpeed: 0.22, emissive: 2.1 },
