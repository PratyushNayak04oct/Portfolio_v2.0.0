...
export default function ProjectCard({ project, index }) {
  return (
    <Link
      ...
      className="group relative flex h-full w-full min-w-0 flex-col justify-between overflow-hidden rounded-2xl border border-white/5 bg-secondary/25 p-5 transition-[border-color,transform,background] duration-500 ease-out hover:border-cyan/35 hover:bg-secondary/40 sm:p-7 lg:min-w-[min(36vw,28rem)] lg:p-9"
    >
      <div>
